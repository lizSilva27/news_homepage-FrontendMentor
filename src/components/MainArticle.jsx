import imgArticleMobile from '../assets/images/image-web-3-mobile.jpg'
import imgArticleDesktop from '../assets/images/image-web-3-desktop.jpg'
...
export const MainArticle = () => {
	return (
		<section className='mb-12'>
			...
			<picture>
				<source media="(max-width:640px)" srcSet={imgArticleMobile} />
				<source media="(min-width:641px)" srcSet={imgArticleDesktop} />
				<img src={imgArticleMobile} alt="Img Article Main" />
			</picture>
